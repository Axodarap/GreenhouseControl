...
#define PIN_FEUCHTE_4     35   // Feuchte Sensor 4
#define PIN_FEUCHTE_5     36   // Feuchte Sensor 5
#define PIN_FEUCHTE_6     39   // Feuchte Sensor 6
#define PIN_FEUCHTE_7     12   // Feuchte Sensor 7 (ADC2 – kann WiFi stören)
#define PIN_FEUCHTE_8     15   // Feuchte Sensor 8 (ADC2 – kann WiFi stören)
